...
/**
 * Updatable part of CarLaunchParamsModifier.
 * TODO: will be changed to the interface in the consecutive CL.
 * @hide
 */
@SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
public final class CarLaunchParamsModifierUpdatable {
    ...
    public CarLaunchParamsModifierUpdatable(CarLaunchParamsModifierInterface builtin) {
        mBuiltin = builtin;
    }
    ...
    public void setDisplayAllowListForUser(@UserIdInt int userId, int[] displayIds) {
        if (DBG) {
            Slog.d(TAG, "setDisplayAllowlistForUser userId:" + userId
                    + " displays:" + Arrays.toString(displayIds));
        }
        synchronized (mLock) {
    ...
    public void setPassengerDisplays(int[] displayIdsForPassenger) {
        if (DBG) {
            Slog.d(TAG, "setPassengerDisplays displays:"
    ...
    private int getUserIdForDisplayLocked(int displayId) {
        return mDisplayToProfileUserMapping.get(displayId, UserHandle.USER_NULL);
    }
