...
public final class CarInputMethodManagerService extends IInputMethodManager.Stub
    ...
    private static final class ClientDeathRecipient implements DeathRecipient {
    ...
    public static final class Lifecycle extends SystemService {
        ...
        public Lifecycle(Context context) {
            super(context);
            mService = new CarInputMethodManagerService(context);
        }
    ...
    public CarInputMethodManagerService(Context context) {
        ...
        mBindingController = new CarInputMethodBindingController(this);
     ...
     *
     * @param client {@link Binder} proxy that is associated with the singleton instance
     *               of {@link InputMethodManager} that runs on the client
     *               process
